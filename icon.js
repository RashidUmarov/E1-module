const btn = document.querySelector('.change-icon');

const icon = document.querySelector('.btn_icon');

let counter=0

const icon_1 =`   <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
const icon_2=`    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
btn.addEventListener('click', () => {
  counter+=1;
  if (counter%2==0){
  icon.innerHTML=icon_1;
  } else
  {
  icon.innerHTML=icon_2;
  }
  console.log(icon_1)
});